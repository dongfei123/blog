...
<div class="mws-panel grid_8">
                    ...
                    <div class="mws-panel-body no-padding">
                    	<form class="mws-form" action="/admin/user/updatedetail" method="post" enctype="multipart/form-data">
                    		...
                    		<div class="mws-form-inline">
                    			<div class="mws-form-row">
                    				...
                    				<div class="mws-form-item">
                    					<input class="large" id="nickname" style="width:500px" type="text" name="nickname" value="{{$info->nickname}}"><span id="nick" style="display:none;">&nbsp;&nbsp;昵称必须为3-30位中文或英文数字及下划线组成</span>
                    				</div>
                    			</div>
                    			...
                    			<div class="mws-form-row">
                    				...
                    				<div class="mws-form-item">
                    					<input class="large" id="name" style="width:500px" type="text" name="name" value="{{$info->name}}"><span id="rname" style="display:none;">&nbsp;&nbsp;姓名必须为2-16位中文或英文组成</span>
                    				</div>
                    			</div>
                    			<?php
                    					$man = $woman = $secret = '';
                    			...
                    			<div class="mws-form-row">
                    				...
                    				<div class="mws-form-item">
                                    	<ul class="mws-form-list">
                                        	<label><input type="radio" name="sex" class="required" value="1" {{$man}}> 男</label>
                                        	&nbsp;&nbsp;
                                        	<label><input type="radio" name="sex" value="0" {{$woman}}> 女</label>
                                        	&nbsp;&nbsp;
                                        	<label><input type="radio" name="sex" value="2" {{$secret}}> 保密</label>
                                        </ul>
                    			...
                    			<div class="mws-form-row">
                    				...
                    				<div class="mws-form-item" id="age">
                    					<input id="birth" class="large" style="width:500px" type="text" name="birth" placeholder="请按2018-1-1格式填写" value="{{$info->birth}}">
                    				</div>
                    			</div>
                    			<div class="mws-form-row">
                                    	...
                                    	<div class="mws-form-item">
                                        	...
                                        	<img style="width:50px;position:relative;left:-155px;top:-30px;" src="{{$info->pic}}"/>
                                        </div>
                                </div>
