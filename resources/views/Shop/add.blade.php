...
<div class="mws-panel grid_8">
                    ...
                    <div class="mws-panel-body no-padding">
                    	<form class="mws-form" action="/admin/shop/insert" method="post" enctype="multipart/form-data">
                    		...
                    		<div class="mws-form-inline">
                    			...
                    			<div class="mws-form-row">
                    				...
                    				<div class="mws-form-item">
                    					...
                    					<script id="editor" type="text/plain" name="descr"   style="width:820px;height:200px;"></script>
                    				</div>
                    			</div>
                    			<div class="mws-form-row">
